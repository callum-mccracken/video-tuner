...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (request.a4Value !== undefined && request.a4Value !== null) {
    getJungle().setPitchOffset(Math.log2(request.a4Value/440.0), false);
